...
public class WriteFeedActivity extends BaseActivity implements View.OnClickListener{
    ...
    public void setToolBar() {
        ...
        //title
        toolBar.getTvCenter().setText("write feed");
        ...
        switch (v.getId()){
            case R.id.btnSure:
                ...
                if (Common.isEmpty(title, content)){
                    ...
                    MyToast.showShort(this,"Title and content cannot be empty\n" +
                            "\n");
                }
                break;
            default:
    ...
    private void sendFeed(int userId,String title,String content){
        ...
        write.enqueue(new Callback<Response>() {
            ...
            public void onResponse(Call<Response> call, retrofit2.Response<Response> response) {
                if (response.body() != null){
                    if (response.body().getStatus().equals("1")){
                        ...
                        MyToast.showShort(WriteFeedActivity.this, "Failed to publish. Please try again later\n" +
                                "\n");
                    }
                }
            }
            ...
            public void onFailure(Call<Response> call, Throwable t) {
                MyLog.i(TAG,"fail "+t);
                MyToast.showShort(WriteFeedActivity.this, "Connection failed. Please try again later\n" +
                        "\n");
            }
        });
    }
