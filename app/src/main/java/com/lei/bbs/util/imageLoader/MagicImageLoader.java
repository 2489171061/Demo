...
import com.lei.bbs.util.MyUtils;
...
public class MagicImageLoader {

    private static final String TAG = "MagicImageLoader";
    ...
    private static final ThreadFactory sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            return new Thread(r,"MagicImageLoader# "+mCount.getAndIncrement());
        }
    };
    ...
    private MagicImageLoader(Context context){
    ...
    public static MagicImageLoader build(Context context){
        return new MagicImageLoader(context);
    }
